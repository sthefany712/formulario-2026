...
async function getDadosCep(cep){ //funções aync são mais lentas por ter que esperar resposta
...
async function preencherFormulario (){
    ...
    const dadosCep = await getDadosCep(cep) //Vai ir no back e trazer as informações
...
document.getElementById('cep')
    ...
    //change, o sistema vai verificar cada digito, se coloco 1 ele vai na API e ve se tem...*
    //quem estarta preencherFormulario é o addEventListener (função CallBack)

//O evento focusout no JavaScript é disparado quando um elemento, ou qualquer elemento dentro dele, perde o foco (o usuário clica fora ou usa Tab para sair).
